...
| `jtf` | [JSON Token Format](https://github.com/k1y0miiii/jtf), реальный вендоренный кодировщик | да | да (декодер JTF) |
...
- [json-token-format (JTF)](https://github.com/k1y0miiii/jtf) — lossless-кодировка JSON с экономией токенов, измеряется здесь (вендоренная).
